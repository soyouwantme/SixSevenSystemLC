...
public class SupplierMerchandiseAdapter extends RecyclerView.Adapter<SupplierMerchandiseAdapter.ViewHolder> {

    private Context mContext;
    private List<AVObject> mMerchandiseList;

    public SupplierMerchandiseAdapter(List<AVObject> merchandiseList,Context context){
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        holder.linearLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(mContext, SupplierDetail.class);
